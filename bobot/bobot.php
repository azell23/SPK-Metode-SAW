...
<div class="container my-4">
 ...
 <form action="bobot/aksi_ubah_bobot.php" method="POST">
   <div class="form-group row">
     <label for="staticEmail" class="col-sm-2 col-form-label">W1 (Rata-Rata Raport)</label>
     <div class="col-sm-10">
       <input type="text"  class="form-control" name="w1" value="<?php echo $row['w1'] ?>">
     </div>
   </div>
   <div class="form-group row">
     <label for="inputPassword" class="col-sm-2 col-form-label">W2 (Sikap)</label>
     <div class="col-sm-10">
   ...
   <div class="form-group row">
     <label for="inputPassword" class="col-sm-2 col-form-label">W4 (Ekstrakulikuler)</label>
     <div class="col-sm-10">
       <input type="text" class="form-control" name="w4" value="<?php echo $row['w4'] ?>">
     </div>
   </div>
   <div class="form-group row">
     <label for="inputPassword" class="col-sm-2 col-form-label">W5 (Prestasi Kejuaraan)</label>
     <div class="col-sm-10">
       <input type="text" class="form-control" name="w5" value="<?php echo $row['w5'] ?>">
     </div>
   </div>
   <div class="form-group row">
