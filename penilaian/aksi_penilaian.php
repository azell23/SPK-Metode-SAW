...
if (isset($_POST['simpan'])) {
 ...
 for ($i=0; $i <$jumlah ; $i++) { 
  ...
  $fix_c5= $_POST[$temp_c5];

  $sql="select * from tbl_nilai where id_nilai='$fix_id_nilai'";
  //echo "$sql";
  $hasil=mysqli_query($koneksi,$sql);
  if (mysqli_num_rows($hasil)<=0) {
   $sql="insert into tbl_nilai(id_alternatif,c1,c2,c3,c4,c5) values('$fix_id_alternatif','$fix_c1','$fix_c2','$fix_c3','$fix_c4','$fix_c5')";
   mysqli_query($koneksi,$sql);
   //echo "$sql";
  }else{
   $sql="update tbl_nilai set c1='$fix_c1', c2='$fix_c2', c3='$fix_c3', c4='$fix_c4', c5='$fix_c5' where id_nilai='$fix_id_nilai'";
   //echo "$sql";
   mysqli_query($koneksi,$sql);
  }
 }
